...
export default class ModelViewerElementBase extends UpdatingElement {
    ...
    get [(_a = $loaded, _b = $loadedTime, _c = $lastDpr, _d = $clearModelTimeout, _e = $fallbackResizeHandler, _f = $resizeObserver, _g = $intersectionObserver, _h = $progressTracker, $renderer)]() {
        return renderer;
    }
    get modelIsVisible() {
