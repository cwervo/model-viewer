...
import { EventDispatcher, Quaternion, Spherical, Vector3 } from 'three';
...
export class SmoothControls extends EventDispatcher {
     ...
     */
    updateIntrinsics(nearPlane, farPlane, aspect) {
    ...
    setOrbit(goalTheta = this[$goalSpherical].theta, goalPhi = this[$goalSpherical].phi, goalRadius = this[$goalSpherical].radius) {
        ...
        const nextTheta = this[$wrapAngle](clamp(goalTheta, minimumAzimuthalAngle, maximumAzimuthalAngle));
    ...
    [(_b = $interactionEnabled, _c = $upQuaternion, _d = $upQuaternionInverse, _e = $isUserChange, _f = $spherical, _g = $goalSpherical, _h = $thetaDamper, _j = $phiDamper, _k = $radiusDamper, _l = $fovDamper, _m = $target, _o = $goalTarget, _p = $targetDamperX, _q = $targetDamperY, _r = $targetDamperZ, _s = $pointerIsDown, _t = $lastPointerPosition, $isStationary)]() {
